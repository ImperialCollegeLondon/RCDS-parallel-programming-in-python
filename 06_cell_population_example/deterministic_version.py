...
def run_realisation(n_initial, reproduction_probability, mean_lifetime, output_times, seed=None):
    ...
    for i_time in range(1, len(output_times)):
        ...
        if output_populations[i_time] == 0 or output_populations[i_time] > 1e4:
            # If the population has died out or exceeded 10,0000, stop the simulation
            break
...
visualise_realisation_runtimes(realisation_df, '06_cell_population_example/deterministic_runtimes.png')
